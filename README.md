...
This repository contains the prod 7.1 (PHP 7.1 production) image which is used by the OrangeHRM PROD Environment. Prod 7.1 image has been extended from the centos/systemd image. 
...
1. get a docker pull - `docker pull orangehrm/orangehrm-environment-images:prod-7.1` 
2. run the image - `docker run -itd --name <NAME> -p 443:443 orangehrm/orangehrm-environment-images:prod-7.1`