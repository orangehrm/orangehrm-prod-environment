...
class WebContainerCest
{
  ...
  public function checkContainerIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker inspect -f {{.State.Running}} prod_web_73");
    ...
    public function checkApacheServiceIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 service httpd status");
        $I->seeInShellOutput('active (running)');
    }

    public function checkApacheInstallation(UnitTester $I){
        $I->wantTo("verify apache is installed in the container");
        $I->runShellCommand("docker exec prod_web_73 httpd -v");
    ...
    public function checkCronInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 yum list installed | grep cron");
    ...
    public function checkCronServiceIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 service crond status");
        $I->seeInShellOutput('active (running)');
    }

    public function checkMySQLClientInstallation(UnitTester $I){
        $I->wantTo("verify mysql-client is installed in the container");
        $I->runShellCommand("docker exec prod_web_73 mysql --version");
    ...
    public function checkLibreOfficeInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 libreoffice --version");
  ...
  public function checkPopplerUtilInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 yum list installed | grep poppler-util");
  ...
  public function checkLibSSLInstallation(UnitTester $I){
          ...
          $I->runShellCommand("docker exec prod_web_73 ldconfig -p | grep libssl");
    ...
    public function checkLibSSHInstallation(UnitTester $I){
            ...
            $I->runShellCommand("docker exec prod_web_73  yum list installed | grep libssh2");
    ...
    public function checkZipInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 zip -v");
    ...
    public function checkUnzipIsInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 unzip -v");
    ...
    public function checkCurlInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_73 curl --version");
        $I->seeInShellOutput('curl 7.29');
    }

    public function checkPHPVersion(UnitTester $I){
        $I->wantTo("verify php 7.3 is installed in the container");
        $I->runShellCommand("docker exec prod_web_73 php --version");
    ...
    public function checkPHPModules(UnitTester $I){
            ...
            $I->runShellCommand("docker exec prod_web_73 php -m");
