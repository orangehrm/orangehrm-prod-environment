...
class WebContainerCest
{
  ...
  public function checkContainerIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker inspect -f {{.State.Running}} prod_web_56");
    ...
    public function checkApacheInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 httpd -v");
    ...
    public function checkCronInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 yum list installed | grep cron");
    ...
    public function checkCronServiceIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 service crond status");
        $I->seeInShellOutput('active (running)');
    }
    ...
    public function checkLibreOfficeInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 libreoffice --version");
  ...
  public function checkPopplerUtilInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 yum list installed | grep poppler-util");
  ...
  public function checkLibSSLInstallation(UnitTester $I){
          ...
          $I->runShellCommand("docker exec prod_web_56 ldconfig -p | grep libssl");
    ...
    public function checkLibSSHInstallation(UnitTester $I){
            ...
            $I->runShellCommand("docker exec prod_web_56  yum list installed | grep libssh2");
    ...
    public function checkZipInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 zip -v");
    ...
    public function checkUnzipIsInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 unzip -v");
    ...
    public function checkCurlInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_56 curl --version");
        $I->seeInShellOutput('curl 7.29');
    }

    public function checkPHPVersion(UnitTester $I){
        $I->wantTo("verify php 5.6 is installed in the container");
        $I->runShellCommand("docker exec prod_web_56 php --version");
    ...
    public function checkPHPModules(UnitTester $I){
            ...
            $I->runShellCommand("docker exec prod_web_56 php -m");
